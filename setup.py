...
def _version_info() -> str:
    ...
    if release_level == 'final':
        ...
        # try and get the last commit hash for a more precise version, if it fails, just use the base version
        try:
            import subprocess
            ...
            END_NOTIFICATION = '\033[0m'
            
            print(NOTIFICATION + 'reactionmenu notification: An error occurred when attempting to get the last commit ID of the repo for a more precise version of the library. Returning base development version instead.' + END_NOTIFICATION)
